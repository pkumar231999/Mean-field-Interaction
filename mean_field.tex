...
(a) Colormap of the local current injected from contact $0$ at $E=-3.2$ and $\phi_a=0.44$. One clearly observes that the propagation takes place on the right edge. 
(b) Transmission (green) and reflection (red, vanishing) probability of the wire versus energy at $\phi_a=0.44$. 
